...
| Max-100 S3 persistence/resource preflight | `/root` only | `logs/route-s3-scale-30ce236-preflight.{stdout,stderr}.log`; private artifacts under `output/route-s3-scale-private/30ce236-preflight/` | Pending. Exact command: `node --expose-gc C:/Users/raede/AppData/Local/Temp/route-s3-preflight-30ce236.mjs C:/Users/raede/Desktop/dev/engagement_project C:/Users/raede/Desktop/dev/engagement_project/output/route-s3-scale-private/30ce236-preflight`. No port/database/network/shared cache. Success requires one admitted manifest companion, one 100-record checkpoint persisted and reloaded in a fresh session, four separate conformance records, a partial combined report with `100/5000`, `4/4`, `evidenceComplete=false`, zero fault flags, and an operational heap/disk summary. First nonzero exit, stopped/fault artifact, denominator drift, or checkpoint admission failure stops the gate with no automatic retry; preserve artifacts for diagnosis. |
| Full S3 1,000 x 5 generation and combine | `/root` only | Generation logs `logs/route-s3-scale-6c251fa-full-generate.{stdout,stderr}.log`; combine logs `logs/route-s3-scale-6c251fa-full-combine.{stdout,stderr}.log`; private artifacts under `output/route-s3-scale-private/6c251fa-full-v1/` | Admitted for one serial no-retry attempt after the max-100 preflight. Generation command: `node --expose-gc C:/Users/raede/AppData/Local/Temp/route-s3-full-generate-6c251fa.mjs C:/Users/raede/Desktop/dev/engagement_project C:/Users/raede/Desktop/dev/engagement_project/output/route-s3-scale-private/6c251fa-full-v1`. Combine command after a complete generation marker: `node --expose-gc C:/Users/raede/AppData/Local/Temp/route-s3-full-combine-6c251fa.mjs C:/Users/raede/Desktop/dev/engagement_project C:/Users/raede/Desktop/dev/engagement_project/output/route-s3-scale-private/6c251fa-full-v1`. No port/database/network/shared cache. Generation persists and reloads a distinct admitted manifest, four conformance records, and 50 chained max-100 main checkpoints. Combine runs in a separate process. Any nonzero exit, stopped/fault artifact, discontinuity, denominator/digest drift, OOM, or incomplete marker stops the gate; preserve the append-only ledger and do not retry automatically. Success requires `5000/5000`, `4/4`, all replay/oracle comparisons admitted by the report contract, `mainComplete=true`, `conformanceComplete=true`, `evidenceComplete=true`, zero fault flags, no emitted claims, and zero performance samples. |
