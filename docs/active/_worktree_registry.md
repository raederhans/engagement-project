...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| C:/Users/raede/Desktop/dev/engagement_project-p1-ui | QoL comparison detail menu (separately owned) | origin/main@784b812 | codex/comparison-detail-menu@20eda9b | Add progressive comparison details without new data requests or unsupported safety ranking | in-progress | docs registry/task, src/compare/card.js, src/i18n/messages.js, src/style.css, Crime tests | branch is clean and four commits ahead of current origin/main; detailed validation and readiness remain owned by that task | Red overlap with current P1 closeout; do not reset, copy, or rewrite | owner decides integration order against latest main | Preserve branch and worktree exactly; its owner handles rebase, validation, and PR. |
| C:/Users/raede/Desktop/dev/engagement_project-chart-studio | Crime chart studio (separately owned) | origin/main@784b812 | codex/chart-studio@a1eea91 | Improve defensible Crime chart comparisons | in-progress | chart rendering, design/UI, related tests and registry | branch and worktree are clean; detailed validation and readiness remain owned by that task | Potential UI/CSS/test overlap with current P1 closeout; do not reset, copy, or rewrite | owner decides integration order against latest main | Preserve branch and worktree exactly; its owner handles rebase, validation, and PR. |
| C:/Users/raede/Desktop/dev/engagement_project-incident-details | Crime incident inspection (separately owned) | origin/main@784b812 | codex/incident-point-details@8f78a61 | Restore incident details without widening Crime queries | in-progress | incident interaction, Crime UI, tests and registry | branch and worktree are clean; detailed validation and readiness remain owned by that task | Potential Crime UI/test overlap with current P1 closeout; do not reset, copy, or rewrite | owner decides integration order against latest main | Preserve branch and worktree exactly; its owner handles rebase, validation, and PR. |
