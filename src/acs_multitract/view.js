const COPY = Object.freeze({
  en: Object.freeze({
    ...
    intro: 'Enter at least two complete Philadelphia tract GEOIDs. We will check them against the bundled 2020–2024 ACS estimate and uncertainty data; nothing is calculated until you choose Calculate.',
  ...
  zh: Object.freeze({
    eyebrow: '完整人口普查区比较',
    title: '比较完整人口普查区',
    intro: '输入至少两个费城人口普查区的 11 位 GEOID。系统会先确认它们存在于内置的 2020–2024 ACS 估计与误差数据中；只有你点击“计算汇总”后才会开始计算。',
