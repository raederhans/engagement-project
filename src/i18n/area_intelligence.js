...
registerMessagePairs({
  ...
  'areaIntelligence.title': ['Read the historical ledger', '历史数据覆盖'],
  'areaIntelligence.subtitle': [
    'Review the complete-coverage admission ledger before checking why no forecast is available.',
    '以下汇总覆盖整个数据集，预测功能暂不可用。',
  ],
  'areaIntelligence.loading': ['Checking the required v2 evidence…', '正在核验历史数据…'],
  ...
  'areaIntelligence.precisionValue': ['Artifact precision: {precision}', '位置精度：{precision}'],
  'areaIntelligence.ledgerTitle': ['Complete-coverage admission ledger', '完整数据集统计'],
  ...
  'areaIntelligence.canonicalRowsLabel': ['Canonical rows seen', '源记录总数'],
  ...
  'areaIntelligence.martRowsLabel': ['Mart rows', '聚合记录数'],
  ...
  'areaIntelligence.noPromotionReason': [
    ...
    '预测暂不可用：{failedPrimarySlices} 项主要区间质量检查未通过。当前仅展示历史统计。',
  ],
